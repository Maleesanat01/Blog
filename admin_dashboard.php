...
<script>
  ...
  <style>
    ...
    .nav > li.active > a:hover {
        background-color: #1ea5c3; /* Background color for active link */
    }
  ...
  .navbar-inverse .navbar-collapse {
    border-top: none; /* Remove the border on top of the navbar */
}
  ...
  .navbar-nav > .active > a:focus {
    ...
    border: transparent !important; /* Set border to transparent */
  }
  ...
  .navbar-default .navbar-toggle.collapsed:hover {
    background-color: #1ea5c3 !important; /* Set background color to #1ea5c3 */
  }

  .navbar-brand img {
    margin-top: -20px; /* Adjust margin-top to align with the menu icon */
  }
